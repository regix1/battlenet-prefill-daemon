...
VERSION_API="https://api.github.com/repos/regix1/battlenet-prefill-daemon/releases"
...
DOWNLOAD_URL="https://github.com/regix1/battlenet-prefill-daemon/releases/download/v${LATEST_TAG}/BattleNetPrefill-${LATEST_TAG}-linux-x64.zip"
